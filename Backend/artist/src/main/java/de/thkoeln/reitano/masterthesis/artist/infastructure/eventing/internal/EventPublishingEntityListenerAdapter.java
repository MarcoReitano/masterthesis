//package de.thkoeln.reitano.masterthesis.artist.infastructure.eventing.internal;
//
//import de.thkoeln.reitano.masterthesis.artist.infastructure.eventing.EventSource;
//
...
//      .getLogger(EventPublishingEntityListenerAdapter.class);
...
//
//  @Autowired
//  public EventPublishingEntityListenerAdapter(EntityManager eventRepository,
...
//            LOG.debug("Published {} event for {} with id {}, version {}", action, entity.getClass(),
//                entity.getId(),
//                entity.getVersion());
//          }
//        });
